...
public class EntityManager<E extends EntityInterface, L extends Location> {
	...
	/**
	 * Allow all the actors stored in the <Code>entityManager<Code> to be stored in an ArrayList of 
	 * <Code>Actor<Code>
	 * @return an array list containing all the <Code>Actor<Code> stored in the <Code>entityManager<Code>
	 */
