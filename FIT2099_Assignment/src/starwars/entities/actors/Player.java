...
public class Player extends SWActor {
	...
	public Player(Team team, int hitpoints, MessageRenderer m, SWWorld world) {
		...
		forceAbility = ForceAbility.LEVEL0;  //initally zero force ability
	}
    ...
    public void giveLightSabres(){
        LightSaber lukeWeapon = new LightSaber(super.messageRenderer);  //give a weapon to tusken raider
        setItemCarried(lukeWeapon);
    }
    
	public void setTrainStatus(boolean status)
	{
		this.hasTrained = status;
	}
