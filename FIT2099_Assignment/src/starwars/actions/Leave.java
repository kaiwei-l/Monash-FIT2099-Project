...
public class Leave extends SWAffordance {
	...
	public void act(SWActor a) {
		if (a.getItemCarried() == null) { // the actor is not holding something
			...
			// If this entity is a lightsaber, then we need to reset its owner
			if(target instanceof LightSaber)
			{
				LightSaber theLightSaber = (LightSaber) target;
				theLightSaber.restoreWeaponCap();
				theLightSaber.setOwner(null);
			}
		}
		}
	}
