...
public enum Capability {
	...
	REPAIR, // REPAIR capability allows an entity to repair another entity which has the FIX Affordance by using
	        // an Entity
	HEAL,//HEAL capability allows an entity to be healed by consuming another entity
}
